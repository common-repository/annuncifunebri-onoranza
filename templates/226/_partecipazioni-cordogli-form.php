    ...
    <div id="annfu_form_cordoglio">
        ...
        <form action="." method="post">
            ...
            <div class="form-group annfu_testo_wrapper">
                <textarea name="testo" id="annfu_testo" class="form-control controllato w-100 max-w-100" placeholder="Testo"></textarea>
            </div>
            ...
            <div class="form-group annfu_recapito_wrapper">
                <span class="annfu_facoltativo">Facoltativo: Un recapito per permettere alla famiglia di inviare un eventuale ringraziamento. (Questo dato non sar&agrave; reso pubblico, ma verr&agrave; comunicato solo alla famiglia)<br/></span>
                <input type="text" name="recapito" id="annfu_recapito" class="form-control controllato w-100 max-w-100"
                       placeholder="Es.: via Verdi 90, Milano (facoltativo)">
            </div>
