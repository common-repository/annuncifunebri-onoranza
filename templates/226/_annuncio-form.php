...
<div id="annfu_form_cordoglio_wrapper">
    ...
    <?php if ($annuncio['abilitatoFotoCordogli'] || $countFiori > 0 || $countOpere > 0): ?>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane" id="annfu_form_cordoglio">
                <?php include_once(ANNFU_PLUGIN_PATH . 'templates/226/_partecipazioni-cordogli-form.php') ?>
            </div>
            <?php if ($annuncio['abilitatoFotoCordogli']): ?>
                <div role="tabpanel" class="tab-pane" id="annfu_form_foto">
                    <?php include_once(ANNFU_PLUGIN_PATH . 'templates/226/_foto-cordogli-form.php') ?>
                </div>
            <?php endif; ?>
            <?php if ($template != 'alternativo2' && $countFiori > 0): ?>
