<div class="annfu_form_foto_cordoglio_wrapper">
    ...
    <p class="annfu_paragrafo_form_foto_cordoglio">La famiglia deciderà poi se renderla visible su questa
        pagina.<br/><strong>Attenzione!</strong> Autenticazione richiesta. Inserisci un numero
        di
        ...
        <form action="." method="post">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" name="nome" id="annfu_foto_nome" class="form-control controllato"
                               placeholder="Nome e Cognome / Ragione Sociale"
                               value="<?php echo isset($_COOKIE['cordoglio_nome']) ? htmlentities($_COOKIE['cordoglio_nome']) : "" ?>"
                               required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" name="telefono" id="annfu_foto_telefono" class="form-control controllato"
                               ...
                               value="<?php echo isset($_COOKIE['cordoglio_telefono']) ? htmlentities($_COOKIE['cordoglio_telefono']) : "" ?>"
                               required>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="dz-didascalia">
                    <small>Trascina nell'area soprastante i file da caricare o clicca su un punto qualsiasi nell'area
                        colorata. Una volta caricato il
                        file, sarà possibile inserire una didascalia per ogni foto. Max 10Mb per ogni foto</small>
                </div>
            </div>
            <div class="form-group">
                <label class="annfu_label_privacy"><input type="checkbox" id="annfu_foto_dati_personali"
                                                          class="annfu_dati_personali annfu_checkbox"/>
                    Acconsento al
                    trattamento dei miei dati personali (<a class="annfu_privacy annfu_pointer">clicca qui per maggiori
                        dettagli</a>).</label>
            </div>
            <div class="form-group">
                <input type="submit" name="invio" value="invia" id="annfu_foto_invio"
                       class="annfu_invio btn btn-default mb-4"
