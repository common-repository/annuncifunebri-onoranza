...
<div class="annfu_social annfu_text_center">
    ...
    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode("Annuncio funebre ".$annuncio['nominativo'].": ").$url.urlencode(" ".$annuncio['hashTag']) ?>" target="_blank" class="annfu_twitter" title="Condividi su Twitter"><i class="fa-brands fa-x-twitter circle-yes"></i></a>
