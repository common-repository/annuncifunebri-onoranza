<div class="annfu_form_cordoglio_wrapper">
    ...
    <div id="annfu_form_cordoglio">
        ...
        <form action="." method="post">
            ...
            <div class="row">
                <div class="col-xs-12 col-lg-4 form-group annfu_nome_wrapper">
                ...
                <div class="col-xs-12 col-lg-4 form-group annfu_mail_wrapper">
                    <input type="text" name="mail" id="annfu_mail" class="form-control controllato"
                           placeholder="Email (consigliato e visibile solo alla famiglia)">
                </div>
                <div class="col-xs-12 col-lg-4 form-group annfu_telefono_wrapper">
                    <input type="text" name="telefono" id="annfu_telefono" class="form-control controllato" required
                           placeholder="Cellulare (visibile solo alla famiglia)">
                </div>
            </div>
            <span class="annfu_facoltativo">Un recapito per permettere alla famiglia di inviare un eventuale ringraziamento. (Questo dato non sar&agrave; reso pubblico)<br/></span>
            <div class="row">
                <div class="col-xs-12 col-lg-6 form-group annfu_recapito_wrapper">
                    <input type="text" name="indirizzo" id="annfu_indirizzo" class="form-control controllato" placeholder="indirizzo" required>
                </div>
                <div class="col-xs-12 col-lg-1 form-group annfu_recapito_wrapper">
                    <input type="text" name="cap" id="annfu_cap" class="form-control controllato" placeholder="cap" required>
                </div>
                <div class="col-xs-12 col-lg-5 form-group annfu_recapito_wrapper">
                    <input type="text" name="citta" id="annfu_citta" class="form-control controllato" placeholder="città" required>
                </div>
            </div>
