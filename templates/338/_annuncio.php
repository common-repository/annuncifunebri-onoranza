<div class="row">
    <div class="col-xs-12 col-sm-12 <?php echo $annuncio['tipoAnnuncio'] != 'ringraziamento' ? '' : 'col-md-8 col-md-offset-2' ?>">
            ...
            <div class="annfu_annuncio text-center <?php echo $showEpigrafe ? 'annfu_none' : '' ?>">
                ...
                <div class="annfu_annuncio_foto">
                    <a href="<?php echo $annuncio['fotoGrande'] ?>">
                        <img style="width:<?php echo get_option('annfu_foto_w_annuncio', ANNFU_FOTO_W_ANNUNCIO) ?>px;height:<?php echo get_option('annfu_foto_h_annuncio', ANNFU_FOTO_H_ANNUNCIO) ?>px"
    ...
    <?php if ($annuncio['tipoAnnuncio'] != 'ringraziamento'): ?>
        <?php include_once(ANNFU_PLUGIN_PATH . 'templates/338/_annuncio-form.php') ?>
    <?php endif; ?>
