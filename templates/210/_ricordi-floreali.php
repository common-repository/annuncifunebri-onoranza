    ...
    <div class="annfu_ricordi_floreali">
        <form action="." method="post" id="annfu_ricordo_floreale_form">
            ...
            <div id="annfu_ricordo_floreale_form_inner">
                ...
                <p class="mb-3"><strong>Vuoi dimostrare la tua vicinanza alla famiglia del defunto?</strong><br/>
                    Il <strong>ricordo floreale</strong> nasce proprio per lasciare un piccolo segno fiorito, un
                    <strong>messaggio che dica "sono qui vicino a te"</strong> e soprattutto un simbolo che resti nel
                    tempo, rifiorendo anno dopo anno dando calore e conforto.</p>
                <p><strong>Scegli la piantina che preferisci, a tutto il resto pensiamo noi.</strong></p>
                ...
                <div class="mt-2 mb-3 annfu_ricordo_floreale_disclaimer">
                    Fratelli Ferrario dichiara che le foto dei "Ricordi floreali" hanno carattere puramente indicativo e
                    possono variare senza alcun obbligo di preavviso.
                </div>
